...
const CFP = () => (
    <section className="cfp-section n1-bg-color pt-120 pb-120 d-flex align-items-center justify-content-center" style={{ minHeight: "80vh" }}>
        <div className="container">
            <div className="row justify-content-center">
                <div className="col-lg-8">
                    <div className="section-area d-grid gap-3 gap-md-4 text-center mb-8">
                        <span className="p7-color fw-semibold fs-eight">CALL FOR PAPERS</span>
                        <h1 className="fs-two fw-bold mb-3">Submit Your Research to Our Conference</h1>
                        <p className="n3-color fs-seven">
                            We invite researchers, practitioners, and students to submit their original work to our upcoming conference. Share your latest findings, innovative ideas, and practical experiences with a vibrant academic and professional community.
                        </p>
                    </div>
                    ...
                    <div className="mb-6 cfp-topics">
                        <h2 className="fs-five fw-semibold mb-2 p7-color">Topics of Interest include, but are not limited to:</h2>
